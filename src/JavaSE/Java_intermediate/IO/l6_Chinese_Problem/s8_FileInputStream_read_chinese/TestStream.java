package JavaSE.Java_intermediate.IO.l6_Chinese_Problem.s8_FileInputStream_read_chinese;
...
注： 在GBK的棋盘上找到的中字后，JVM会自动找到中在UNICODE这个棋盘上对应的数字，
并且以UNICODE上的数字保存在内存中。
 */
